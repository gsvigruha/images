...
callbacks = [tf.keras.callbacks.EarlyStopping(monitor='val_loss', patience=50),
             tf.keras.callbacks.ModelCheckpoint(filepath='urban.c3.best.h5', monitor='val_loss', save_best_only=True)]
...
tf.keras.models.save_model(model1, '/home/gsvigruha/urban.model.c3.h5', include_optimizer=False)
