...
do_0 = tf.keras.layers.Dropout(0.1)(pool_11)
...
do_1 = tf.keras.layers.Dropout(0.1)(pool_13)

conv_22 = tf.keras.layers.Conv2D(32, kernel_size=(3, 3),
                 activation='relu', padding='same',
                 kernel_initializer='he_normal')(do_1)
pool_23 = tf.keras.layers.MaxPooling2D((4, 4))(conv_22)


do_2 = tf.keras.layers.Dropout(0.2)(pool_23)
...
do_2 = tf.keras.layers.Dropout(0.25)(pool_4)
...
callbacks = [tf.keras.callbacks.EarlyStopping(monitor='val_loss', patience=50),
             tf.keras.callbacks.ModelCheckpoint(filepath='mountain.c3.best.h5', monitor='val_loss', save_best_only=True)]

model1.fit(train_dataset, epochs=200, steps_per_epoch=32, validation_data=test_dataset, validation_steps=40, callbacks=callbacks)
...
tf.keras.models.save_model(model1, '/home/gsvigruha/mountain.model.c3.h5', include_optimizer=False)
