...
conv_11 = tf.keras.layers.Conv2D(64, kernel_size=(3, 3),
...
conv_12 = tf.keras.layers.Conv2D(64, kernel_size=(3, 3),
                 activation='relu', padding='same',
...
conv_22 = tf.keras.layers.Conv2D(64, kernel_size=(3, 3),
                 activation='relu', padding='same',
                 kernel_initializer='he_normal')(do_1)
pool_23 = tf.keras.layers.AveragePooling2D((2, 2))(conv_22)


do_2 = tf.keras.layers.Dropout(0.25)(pool_23)


conv_3 = tf.keras.layers.Conv2D(64, kernel_size=(3, 3),
                 activation='relu', padding='same',
                 kernel_initializer='he_normal')(do_2)
pool_4 = tf.keras.layers.MaxPooling2D((2, 2))(conv_3)

do_3 = tf.keras.layers.Dropout(0.25)(pool_4)


conv_5 = tf.keras.layers.Conv2D(64, kernel_size=(3, 3),
                 activation='relu', padding='same',
                 kernel_initializer='he_normal')(do_3)
pool_6 = tf.keras.layers.AveragePooling2D((4, 4))(conv_5)


do_4 = tf.keras.layers.Dropout(0.4)(pool_6)

conv_7 = tf.keras.layers.Conv2D(64, kernel_size=(3, 3),
                 activation='relu', padding='same',
...
model1.fit(train_dataset, epochs=50, steps_per_epoch=64, validation_data=test_dataset, validation_steps=40)
...
tf.keras.models.save_model(model1, '/home/gsvigruha/water.model.c3.h5', include_optimizer=False)
