...
def create_model_v3():
  ...
  conv_1_1 = tf.keras.layers.Conv2D(16, kernel_size=(3, 3), activation='elu', padding='same',
                                 kernel_initializer='he_normal')(input_1)
  conv_1_2 = tf.keras.layers.Conv2D(16, kernel_size=(3, 3), activation='elu', padding='same',
                                 kernel_initializer='he_normal')(input_1)
  ...
  layer_25x25_shift = pool_ma(layer_5x5_tile, (5, 5), 16, (1, 1), (3, 3))
  layer_25x25_tile = pool_ma(layer_5x5_tile, (5, 5), 16, (5, 5), (3, 3))

  layer_125x125 = pool_ma(layer_25x25_tile, (5, 5), 4, (1, 1), (3, 3))
  layer_175x175 = pool_ma(layer_25x25_tile, (7, 7), 4, (1, 1), (3, 3))

  layer_25x25_conv = tf.keras.layers.Conv2D(8, kernel_size=(3, 3), activation='elu', padding='same',
                                 kernel_initializer='he_normal')(layer_25x25_shift)
  ...
  up_25x25_conv = tf.keras.layers.UpSampling2D(size=(5, 5), interpolation='nearest')(layer_25x25_conv)
