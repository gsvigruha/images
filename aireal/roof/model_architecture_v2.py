...
def create_model_v2(input_size):

  input_1 = tf.keras.layers.Input(shape=(875,875,input_size,))


  conv_1_1 = tf.keras.layers.Conv2D(8, kernel_size=(3, 3), activation='elu', padding='same',
                                 kernel_initializer='he_normal')(input_1)
  conv_1_2 = tf.keras.layers.Conv2D(8, kernel_size=(3, 3), activation='elu', padding='same',
                                 kernel_initializer='he_normal')(input_1)
  conv_1 = tf.keras.layers.Concatenate(axis=-1)([conv_1_1, conv_1_2])


  layer_5x5_shift = pool_ma(conv_1, (5, 5), 8, (1, 1), (3, 3))
  layer_5x5_tile = pool_ma(conv_1, (5, 5), 8, (5, 5), (3, 3))

  layer_25x25_shift = pool_ma(layer_5x5_tile, (5, 5), 6, (1, 1), (3, 3))
  layer_25x25_tile = pool_ma(layer_5x5_tile, (5, 5), 6, (5, 5), (3, 3))

  layer_125x125 = pool_ma(layer_25x25_tile, (5, 5), 6, (1, 1), (3, 3))
  layer_175x175 = pool_ma(layer_25x25_tile, (7, 7), 6, (1, 1), (3, 3))
  ...
  layer_25x25_conv = tf.keras.layers.Conv2D(4, kernel_size=(3, 3), activation='elu', padding='same',
                                 kernel_initializer='he_normal')(layer_25x25_tile)
  ...
  conv_f = tf.keras.layers.Conv2D(4, kernel_size=(1, 1),
